...
players-own [
  ...
  chanPs  ;; Number of pools' changes
  chanFs  ;; Number of FDs' changes
  fd1prs  ;; How many times during the simulation have been agent present at FD1
]
...
to choose-fund
  ...
  set myFund chosenFund

  ;; paying enteringFee - fee is paid if an IPL just entered the FD (during the Step 1 is not paid)
  if myFund != before and ticks > 0 [
    paying-entering-fee
    set chanFs (chanFs + 1)
  ]

  ;; Storing information on presence at FD1
  set fd1prs (fd1prs + myFund)
end
...
to save-players-rules-and-results
  ...
  file-open "results8jj.csv"

  ;; Each PL writes in its own variables (ID, RULE, pChoiceFD0, WALLET, chanFs, and chanPs) and contextual variables (all others)
  ask players [
    file-print (word
      RS ";"
      N ";"
...
<experiments>
  ...
  <experiment name="SOU6b" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    ...
    <steppedValueSet variable="RS" first="30" step="1" last="100"/>
    <enumeratedValueSet variable="N">
      <value value="30"/>
      <value value="50"/>
      <value value="62"/>
  ...
  <experiment name="SOU6c" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <metric>count [assigned] of fund 1</metric>
  ...
  <experiment name="SOU6d" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <metric>count [assigned] of fund 1</metric>
    ...
    <steppedValueSet variable="RS" first="101" step="1" last="170"/>
    <enumeratedValueSet variable="N">
      <value value="30"/>
      <value value="50"/>
      <value value="62"/>
  ...
  <experiment name="SOU6e" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <metric>count [assigned] of fund 1</metric>
    ...
    <steppedValueSet variable="RS" first="171" step="1" last="240"/>
    <enumeratedValueSet variable="N">
      <value value="30"/>
      <value value="50"/>
      <value value="62"/>
  ...
  <experiment name="SOU6f" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <metric>count [assigned] of fund 1</metric>
    ...
    <steppedValueSet variable="RS" first="241" step="1" last="310"/>
    <enumeratedValueSet variable="N">
      <value value="30"/>
      <value value="50"/>
      <value value="62"/>
  ...
  <experiment name="SOU6g" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <metric>count [assigned] of fund 1</metric>
    ...
    <steppedValueSet variable="RS" first="311" step="1" last="390"/>
    <enumeratedValueSet variable="N">
      <value value="30"/>
      <value value="50"/>
      <value value="62"/>
  ...
  <experiment name="SOU6h" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <metric>count [assigned] of fund 1</metric>
    ...
    <steppedValueSet variable="RS" first="391" step="1" last="470"/>
    <enumeratedValueSet variable="N">
      <value value="30"/>
      <value value="50"/>
      <value value="62"/>
  ...
  <experiment name="SOU8" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <enumeratedValueSet variable="randomSeed?">
  ...
  <experiment name="SOU8b" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <enumeratedValueSet variable="randomSeed?">
  ...
  <experiment name="SOU8j" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <enumeratedValueSet variable="randomSeed?">
  ...
  <experiment name="SOU8jj" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>save-players-rules-and-results</final>
    <enumeratedValueSet variable="randomSeed?">
